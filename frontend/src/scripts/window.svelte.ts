...
export { focus, snapPreview, snapAnimatingIds, getWindows, getWindow, openWindow, closeWindow, finishClose, focusWindow, minimizeWindow, finishMinimize, restoreWindow, toggleMaximize, moveWindow, resizeWindow, defocusAll, isTopWindow, reorderWindow, snapWindow, finishSnapAnimation } from './window-store.svelte';
