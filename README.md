...
- **Backend:** Not used yet (prepared as Bun application)
- **Frontend:** Svelte
...
[![Star History Chart](https://api.star-history.com/svg?repos=libersoft-org/yellow-os&type=Date)](https://star-history.com/#libersoft-org/yellow-os&Date)
